...
(function(exports) {
  ...
  var haloApp = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("Hello World") ]);
      };
      var $$eval = function (v) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(haloApp)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
  exports["Query"] = Query;
  exports["haloApp"] = haloApp;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();